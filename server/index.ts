...
// Heidi "take down for now" pages: keep a hard 404 until her copy arrives.
// Do not invent replacement content or 301 these URLs away.
...
const LEGACY_REDIRECTS: Record<string, string> = {
  ...
  '/canary-approach/overview/': '/approach/overview',
  // Heidi "remove completely" GSC 404 fix: permanently removed pages 301 to the closest live section.
